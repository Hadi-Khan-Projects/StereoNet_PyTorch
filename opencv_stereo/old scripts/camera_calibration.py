...
# prepare object points, like (0,0,0), (20,0,0), (40,0,0) ....,(140,160,0)
...
imagesL = glob.glob("C:/Users/User/Desktop/StereoNet/StereoNet_PyTorch/cv2_implementation/calib_images/left/*.jpg")
imagesR = glob.glob("C:/Users/User/Desktop/StereoNet/StereoNet_PyTorch/cv2_implementation/calib_images/right/*.jpg")
...
np.save('left.npy', [left_map1, left_map2])
np.save('right.npy', [right_map1, right_map2])